...
public class FreeBoard {
	...
	public int getBbsReportCount() {
		return bbsReportCount;
	}
	public void setBbsReportCount(int bbsReportCount) {
		this.bbsReportCount = bbsReportCount;
	}
