...
$(function(){
	...
	$("ul.tabs li").click(function(){
		...
		var url = "<%=cp%>/admin/cs/list?group="+tab;
		location.href=url
...
<div class="body-container" style="width: 1009px; margin: 0px auto;">
	<div class="body-title">
		<h3><i class="fas fa-question-circle"></i> 고객센터 관리</h3>
	</div>
		...
		<div style="clear: both;">
			<ul class="tabs">
				...
				<li id="tab-3" data-tab="3">
					유기동물</li>
				<li id="tab-4" data-tab="4">
					강아지용품</li>
				<li id="tab-5" data-tab="5">
					고양이용품</li>
				<li id="tab-6" data-tab="6">
					놀이터게시판</li>
				<li id="tab-7" data-tab="7">
					멍냥수다방</li>
				<li id="tab-8" data-tab="8">
					내정보관리</li>
				<li id="tab-9" data-tab="9">
					기타</li>
		...
		<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
		   <tr height="40">
		      <td align="left" width="70" style="padding-left: 20px;">
		          <button type="button" class="btnConfirm" onclick="javascript:location.href='<%=cp%>/admin/cs/list';">초기화</button>
		      </td>
		      <td align="left" width="200" style="padding-left: 150px;">
		          <form name="searchForm" action="<%=cp%>/admin/cs/list" method="post">
