...
<div class="wide-container">
	<div class="body-title">
		<span style="font-family: Webdings"><i class="fas fa-paw" style="color: #d96363;"></i> 회사연혁</span>
	</div>

	<div>
		<div style="width: 100%;" align="center">
					<img width="600px" height="150px" src="<%=cp%>/resource/img/logos/dogcatdogcat.png">
		</div>
