	...
	<c:forEach var="vo" items="${replyList}">
	    ...
	    <tr>
	        <td style='padding:7px 5px;'>
	            <button type='button' class='smallWhiteBtn btnReplyAnswerLayout' data-replyNum='${vo.lostPetReplyNum}'>답글 <span id="answerCount${vo.lostPetReplyNum}">${vo.answerCount}</span></button>
	        </td>
	    </tr>
	        ...
	        <td colspan='2'>
	            ...
	            <div style='clear: both; padding: 10px 10px;'>
	             ...
	             <div style='padding: 0px 13px 10px 10px; text-align: right;'>
	                <button type='button' class='smallWhiteBtn btnSendReplyAnswer' data-replyNum='${vo.lostPetReplyNum}' style="width: 80px;">답글 등록</button>
	            </div>
