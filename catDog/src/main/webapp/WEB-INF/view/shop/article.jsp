	...
	<div class="shin_body"> 
		...
		<div style="clear: both;" id="menu-deliver">
			...
			<div class="admin_msg">
				...
				<p>
					<b>- 반품주소 :</b>&nbsp;경기도 화성시 서신면 전곡산단9길 5, 백운엔지니어링 A동 멍냥개냥물류센터
				</p>
				<p>
					<b>- 반품 연락처 :</b> 1234-1234
				</p>
				<p>
					<b>- 반품 택배사 : </b>한진택배
				</p>
				...
				<p>
					<b>- 출하지 주소 : </b>경기도 화성시 서신면 전곡산단9길 5, 백운엔지니어링 A동 멍냥개냥물류센터
				</p>
				<p>
					<b>- 출하지 연락처 :</b> 1234-1234
				</p>
			</div>
		</div>
		<div id="menu-refund">
			...
			<p>- 고객 변심으로 교환/반품을 원할 경우, 무료배송으로 상품을 받아 보셨다면 왕복 택배비 6,000원,</p>
			  ...
			  <div class="admin_msg">
				...
				<p>- 환불관련 자세한 사항은 카카오톡 @멍냥개냥 또는 멍냥개냥 서비스센터 1234-1234 로 문의주시기 바랍니다.</p>
              </div>
              <br>
              <div class="admin_msg">
				<p>
				...
				<p>- 소비자분쟁해결 기준(공정거래위원회 고시)에 따라 피해를 보상받을 수 있습니다.</p><p>- "식품"의 경우 A/S가 불가능 합니다.</p><p>- 상품 제조사의 A/S 기준에 따릅니다.&nbsp;</p><p>- A/S 관련 자세한 사항은 카카오톡 @멍냥개냥 또는 멍냥개냥 고객센터 1234-1234 로 문의주시기 바랍니다.</p>
              </div>
		</div>
		</div>
