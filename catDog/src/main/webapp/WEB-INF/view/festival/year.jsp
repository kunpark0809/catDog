...
function changeDate(year) {
	var url="<%=cp%>/festival/year?year="+year;
	location.href=url;
}
			...
			<table id="yearCalendar" style="width: 900px; margin-top: 5px; border-spacing: 0px; border-collapse: collapse;">
				<c:forEach var="m" begin="1" end="12" step="3">
					<tr align="center" height="33">
						...
						<td width="35">&nbsp;</td>
						<td colspan="7" align="center" style="font-weight: 600;">${m+1}월</td>
						<td width="35">&nbsp;</td>
						<td colspan="7" align="center" style="font-weight: 600;">${m+2}월</td>
					</tr>
					<tr align="center" height="33">
						...
						<td width="35" style="color: #0000ff;" class="lineBottomRight lineLeft lineTop">토</td>
						<td width="35">&nbsp;</td>
