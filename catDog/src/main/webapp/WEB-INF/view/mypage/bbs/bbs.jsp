...
<div class="container-board">
	<div>
		<table style="width: 100%; margin: 20px auto 0px; border-spacing: 0px;">
			<tr height="35">
				<td align="left" width="50%">
					${dataCountMpBbs}개(${page}/${total_page} 페이지)
				</td>
				<td align="right">
					&nbsp;
				</td>
		...
		<c:forEach var="dto" items="${listMpBbs}">
			<tr align="center" bgcolor="#ffffff" height="35" style="border-bottom: 1px solid #cccccc;"> 
				<td>${dto.bbsListNum}</td>
				<td align="left" style="padding-left: 10px;">
					<a href="${articleUrl}&bbsNum=${dto.bbsNum}">${dto.bbsSubject}</a>
      			</td>
				<td>${dto.nickName}</td>
				<td>${dto.bbsCreated}</td>
				<td>${dto.bbsHitCount}</td>
			</tr>
		</c:forEach>
		...
		<table style="width: 100%; border-spacing: 0px;">
			<tr height="35">
				<td align="center">
					${dataCountMpBbs==0 ? "등록된 자료가 없습니다." : paging}
				</td>
			</tr>
		</table>
