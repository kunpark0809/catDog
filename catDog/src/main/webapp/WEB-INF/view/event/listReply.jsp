		...
		<c:forEach var="vo" items="${listReply}">
			...
			<tr>
				<td style='padding:7px 5px;'>
					<button type='button' class='btn btnReplyAnswerLayout' data-eventReplyNum='${vo.eventReplyNum}'>답글 <span id="answerCount${vo.eventReplyNum}">${vo.answerCount}</span></button>
				</td>
			</tr>
			<tr class='replyAnswer' style='display: none;'>
				<td colspan='2'>
					...
					<div style='padding: 0px 13px 10px 10px; text-align: right;'>
						<button type='button' class='btn btnSendReplyAnswer' data-eventReplyNum='${vo.eventReplyNum}'>답글 등록</button>
					</div>
				</td>
			</tr>
