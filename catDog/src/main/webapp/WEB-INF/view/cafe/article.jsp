...
<div class="wide-container">
	 <div class="body-title">
		<span><i class="fas fa-utensils"></i> 카페/식당 </span>
	</div>
		...
		<table style="width: 98%; margin: 10px auto 0px; border-spacing: 0px; border-collapse: collapse; border-top: 3px solid; border-color: #d96262;">
			...
			<tr height="45">
			    <td align="center">
			    <br>
			        <button type="button" class="bts" onclick="javascript:location.href='<%=cp%>/cafe/list?${query}';">목록</button>
			    </td>
			 </table>  
			 ...
			 <tr>
			    <td align="right">
			       <c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId=='admin2' || sessionScope.member.userId=='admin3'}">				    
			         <button type="button" class="bts" onclick="updateCafe('${dto.recommendNum}');">수정</button>
			       </c:if>
			       <c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId=='admin2' || sessionScope.member.userId=='admin3'}">				    
			         <button type="button" class="bts" onclick="deleteCafe('${dto.recommendNum}');">삭제</button>
			       </c:if>
			    </td>
			</tr>
			</table>
