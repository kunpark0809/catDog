		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<p class="section-heading text-uppercase" style="font-size: 45px; font-weight:bold; border-bottom: 3px solid; border-bottom-width: 100%; padding-bottom: 20px;">훈련/유치원</p>
				</div>
			</div>
    	</div>
    <div>
		<form name="trainingForm" method="post" enctype="multipart/form-data" onsubmit="return submitContents(this);">
			...
			<table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center">
			        ...
			        <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/training/list';">${mode=='update'?'수정취소':'등록취소'}</button>
