		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<p class="section-heading text-uppercase" style="font-size: 45px; font-weight:bold; border-bottom: 3px solid; padding-bottom: 20px;">훈련/유치원</p>
				</div>
			</div>
    	</div>
    <div>
			...
			<table style="width: 100%; margin: 0px auto; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center">
			        ...
			        <button type="button" class="bts" onclick="javascript:location.href='<%=cp%>/training/list';">${mode=='update'?'수정취소':'등록취소'}</button>
