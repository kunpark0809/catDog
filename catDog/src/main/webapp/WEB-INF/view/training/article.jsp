...
<div class="wide-container">
	 <div class="body-title">
		&nbsp;<span><i class="fas fa-baby-carriage"></i> 훈련/유치원 </span>
	</div>
		...
		<table style="width: 98%; margin: 10px auto 0px; border-spacing: 0px; border-collapse: collapse; border-top: 3px solid; border-color: #d96262;">
			...
			<tr height="45">
			    <td align="center">
			    <br>
			        <button type="button" class="bts" onclick="javascript:location.href='<%=cp%>/training/list?${query}';">목록</button>
			    </td>
			 </table>  
			 ...
			 <tr>
			    <td align="right">
			       <c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId=='admin2' || sessionScope.member.userId=='admin3'}">				    
			         <button type="button" class="bts" onclick="updateTraining('${dto.recommendNum}');">수정</button>
			       </c:if>
			       <c:if test="${sessionScope.member.userId=='admin' || sessionScope.member.userId=='admin2' || sessionScope.member.userId=='admin3'}">				    
			         <button type="button" class="bts" onclick="deleteTraining('${dto.recommendNum}');">삭제</button>
			       </c:if>
			    </td>
			</tr>
			</table>
